                ...
                <div>
                    <form action="doinsert.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" id="clave" name="clave" placeholder="Introduce la clave del usuario">
                        </div>
                        <div class="form-group">
                            <label for="fechalt">Fecha de alta del usuario</label>
                            <input required type="text" class="form-control" id="fechalt" name="fechalt" placeholder="Introduce la fecha de alta del usuario">
                        </div>
